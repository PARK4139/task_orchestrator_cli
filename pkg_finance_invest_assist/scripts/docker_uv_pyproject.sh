...
# Docker + uv + pyproject.toml 개발 환경 스크립트

echo "🐳 Docker + uv + pyproject.toml 개발 환경을 시작합니다..."
echo ""
...
# API 서비스 빌드 및 시작 (pyproject.toml 사용)
echo "🏗️ API 서비스 빌드 중 (pyproject.toml 사용)..."
cd infra
...
echo ""
echo "✅ Docker + uv + pyproject.toml 개발 환경이 시작되었습니다!"
echo ""
echo "📊 서비스 URL:"
...
echo ""
echo "📦 pyproject.toml 장점:"
echo "  - 현대적인 Python 프로젝트 관리"
echo "  - 의존성 그룹 관리 (dev, test 등)"
echo "  - 빌드 시스템 통합"
echo "  - 코드 품질 도구 설정 통합" 