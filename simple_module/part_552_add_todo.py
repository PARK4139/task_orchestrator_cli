...
def add_todo():
    ...
    memo_todo_txt = rf"{pk_system_layer_static_logic.D_PKG_TXT}/memo_todo.txt"
    memo_todo_txt = get_pnx_os_style(memo_todo_txt)
    memo_trash_bin_txt = rf'{pk_system_layer_static_logic.D_PKG_TXT}/memo_trash_bin.txt'
    memo_trash_bin_txt = get_pnx_os_style(memo_trash_bin_txt)
    memo_done_txt = rf'{pk_system_layer_static_logic.D_PKG_TXT}/memo_done.txt'
