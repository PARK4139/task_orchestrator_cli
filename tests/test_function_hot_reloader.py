...
import pytest
from pkg_py.pk_core import ensure_f_list_change_stable
import os
...
def disable_side_effects(monkeypatch):
    monkeypatch.setattr('pkg_py.pk_core.get_pnx_os_style', lambda x: x)
    monkeypatch.setattr('os.path.exists', lambda path: True)
    monkeypatch.setattr('pkg_py.pk_colorful_cli_util.pk_print', lambda *args, **kwargs: None)
    monkeypatch.setattr('pkg_py.pk_core.pk_sleep', lambda secs: None)
