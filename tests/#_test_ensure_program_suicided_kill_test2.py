#!/usr/bin/env python3
"""
pk_ensure_pk_system_started.py 창 닫기 테스트
"""
import os
import sys
...
def test_ensure_program_suicided_kill2():
    """pk_ensure_pk_system_started.py 창 닫기 테스트"""
    ensure_printed("🔍 pk_ensure_pk_system_started.py 창 닫기 테스트", print_color="blue")
    ...
    try:
        ...
        # pk_ensure_pk_system_started.py 창 찾기
        target_windows = [(hwnd, title) for hwnd, title in all_windows 
                         if 'pk_ensure_pk_system_started.py' in title]
        
        ensure_printed(f"📊 pk_ensure_pk_system_started.py 창 개수: {len(target_windows)}", print_color="blue")
    ...
    try:
        ...
        # pk_ensure_pk_system_started.py 파일 경로
        target_file = "pkg_py/pk_ensure_pk_system_started.py"
    ...
    try:
        ...
        ensure_printed(f"📊 호출 후 pk_ensure_pk_system_started.py 창 개수: {len(target_windows_after)}", print_color="blue")
...
if __name__ == "__main__":
    test_ensure_program_suicided_kill2() 