...
if __name__ == '__main__':
    try:
        ...
        #, D_PROJECT, '[ TRY GUIDE ]', '[ DEBUGGING NOTE ]', '[ EXCEPTION DISCOVERED ]'
        # from pkg_py.system_object.500_live_logic import assist_to_ensure_pk_project_cmake_ran
        #
        if is_os_windows():
            chcp_65001()
        assist_to_ensure_pk_project_cmake_ran()
