...
def ensure_pk_wsl_distro_installed():
    ...
    ensure_printed(f'''wsl_distro_name_installed={wsl_distro_name_installed} {'%%%FOO%%%' if LTA else ''}''')
    ...
    ensure_printed(f'''wsl_distro_name_installed_after={wsl_distro_name_installed_after} {'%%%FOO%%%' if LTA else ''}''')
