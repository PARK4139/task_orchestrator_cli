...
def ensure_pk_system_processes_restarted():
    import asyncio
    ...
    if not is_office_pc():
        ...
        # without window
        f_list = [
            # f'{D_PROJECT_RELEASE_SERVER}/pk_run_ensure_release_server_ran.py',
        ...
        # f_cmd
        # pnx = rf"{D_PROJECT_RELEASE_SERVER}/run_ensure_release_server_ran.cmd"
