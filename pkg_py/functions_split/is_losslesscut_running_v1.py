...
from pkg_py.functions_split.ensure_command_excuted_to_os_cashed import ensure_command_excuted_to_os_cashed
...
def is_losslesscut_running_v1():
    ...
    # std_list = ensure_command_excuted_to_os_cashed(cmd='tasklist.exe | findstr "LosslessCut.exe"')
