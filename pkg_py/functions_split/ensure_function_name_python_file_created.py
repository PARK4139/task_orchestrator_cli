...
def ensure_function_name_python_file_created():
    ...
    while True:
        ...
        splited_function_template = "splited_function_template"
        ...
        if d_working == D_PKG_PY:
            ...
            template_option = splited_function_template
        ...
        if template_option == F_PK_TEST_PK_PYTHON_PROGRAM_STRUCTURE_PY:
            if os.path.abspath(template_option) == os.path.abspath(F_PK_TEST_PK_PYTHON_PROGRAM_STRUCTURE_PY):
        ...
        elif template_option == splited_function_template:
