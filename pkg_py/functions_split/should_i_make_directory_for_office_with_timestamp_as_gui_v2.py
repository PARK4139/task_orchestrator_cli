def should_i_make_directory_for_office_with_timestamp_as_gui_v2():
    from pkg_py.functions_split import ensure_pnx_made, get_time_as_
    from pkg_py.functions_split.is_pnx_required import is_pnx_required
    ...
    try:
        ...
        ensure_printed(str_working=rf'''work_n="{work_n}"  {'%%%FOO%%%' if LTA else ''}''')
