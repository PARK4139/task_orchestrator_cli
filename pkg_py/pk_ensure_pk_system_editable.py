...
if __name__ == "__main__":
    # from pkg_py.workspace.pk_workspace import is_office_pc_v2
    ...
    from pkg_py.system_object.files import F_PYCHARM64_EDITION_EXE, F_PYCHARM64_EDITION_EXE
    ...
    try:
        ...
        # todo : ensure_pycharm_opened()
        if is_office_pc_v2():
            f_pycharm = get_pnx_os_style(F_PYCHARM64_EDITION_EXE)
        else:
            f_pycharm = get_pnx_os_style(F_PYCHARM64_EDITION_EXE)
