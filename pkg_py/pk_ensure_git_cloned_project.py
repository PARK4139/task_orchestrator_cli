...
from pkg_py.functions_split.move_pnxs_without_overwrite import move_pnxs_without_overwrite
from pkg_py.system_object.directories import D_PKG_TXT, D_PK_RECYCLE_BIN
...
#, print_red
# from pkg_py.system_object.500_live_logic import ensure_command_excuted_to_os, get_n, remove_pnx_parmanently, does_pnx_exist, get_values_from_historical_file_routine
...
if __name__ == "__main__":
    try:
        ...
        if does_pnx_exist(pnx=f_historical):
            ...
            move_pnxs_without_overwrite(pnxs=[f_historical], dst=D_PK_RECYCLE_BIN)
        # ***
