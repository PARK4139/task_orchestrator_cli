...
#         ensure_printed(f'''{f_pnx} does not exist %%%FOO%%%''', print_color='red')
...
#         # from pkg_py.system_object.static_logic import D_PROJECT, UNDERLINE, STAMP_TRY_GUIDE, STAMP_PYTHON_DEBUGGING_NOTE, STAMP_EXCEPTION_DISCOVERED, UNDERLINE, STAMP_TRY_GUIDE, STAMP_PYTHON_DEBUGGING_NOTE, STAMP_EXCEPTION_DISCOVERED
#         # , pk_deprecated_get_d_current_n_like_person, get_list_from_f, does_pnx_exist, get_str_from_list, print_highlighted
#         #
#         import traceback
#
#         main()
...
#
#         ensure_printed(f'{PK_UNDERLINE}', print_color='red')
#         for traceback_format_exc_str in traceback_format_exc_list:
#             ensure_printed(f'{STAMP_EXCEPTION_DISCOVERED} {traceback_format_exc_str}', print_color='red')
#         ensure_printed(f'{PK_UNDERLINE}', print_color='red')
#
#         ensure_printed(f'{PK_UNDERLINE}', print_color="yellow")
#         ensure_printed(f'{STAMP_PYTHON_DEBUGGING_NOTE} f_current={f_current_n} d_current={d_current_n}', print_color="yellow")
#         ensure_printed(f'{PK_UNDERLINE}', print_color="yellow")
#
#         ensure_printed(f'{PK_UNDERLINE}')
#         ensure_printed(f'{STAMP_TRY_GUIDE} {script_to_run_python_program_in_venv}')
#         ensure_printed(f'{PK_UNDERLINE}')
