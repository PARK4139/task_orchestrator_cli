...
if __name__ == '__main__':
    try:
        ...
        from pkg_py.pk_core import pk_deprecated_get_d_current_n_like_person, get_f_current_n, pk_copy, pk_assist_to_ensure_f_list_organized_by_nx_delimiter
        from pkg_py.pk_core_constants import D_PROJECT, UNDERLINE, STAMP_TRY_GUIDE, STAMP_EXCEPTION_DISCOVERED
        from pkg_py.pk_colorful_cli_util import pk_print

        pk_assist_to_ensure_f_list_organized_by_nx_delimiter()
