...
from pkg_py.functions_split.ensure_chatGPT_responded import ensure_chatGPT_responded
...
def pk_ensure_chatGPT_responded(
    question: str,
    api_key: str = None,
    ...
    Returns:
        str: ChatGPT의 답변
    """
    return ensure_chatGPT_responded(
        question=question,
        api_key=api_key,
        model=model,
...
def ask_simple_question(question: str) -> str:
    """간단한 질문 함수"""
    return ensure_chatGPT_responded(question)
...
if __name__ == "__main__":
    ...
    try:
        ...
        # 대화 기록 출력
        from pkg_py.functions_split.ensure_chatGPT_responded import print_chat_history
        print_chat_history()
