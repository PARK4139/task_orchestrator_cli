if __name__ == "__main__":
    ...
    #  import get_d_current_n_like_person, get_f_current_n, ensure_todo_list_guided
    #

    try:
        
        #  import get_d_current_n_like_person, get_f_current_n, ensure_todo_list_added, ensure_todo_list_guided
        #
