#!/usr/bin/env python3
"""
WSL에서 직접 실행하는 fin_service 컨테이너 빌드 테스트
"""
import subprocess
import sys
import os
...
def test_wsl_fin_service_container_build():
    """
    WSL 환경에서 fin_service 컨테이너 빌드 테스트
    """
...
if __name__ == "__main__":
    success = test_wsl_fin_service_container_build()
    if success:
