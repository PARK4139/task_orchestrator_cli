...
if __name__ == '__main__':
    try:
        import traceback
        #  import deprecated_get_d_current_n_like_person, get_f_current_n, chcp_65001, get_os_n, ensure_tree_organized, gather_empty_d, get_p, organize_d_list_by_stamp
        # from pkg_py.system_object.static_logic import D_PROJECT, UNDERLINE, '[ TRY GUIDE ]', '[ DEBUGGING NOTE ]', '[ EXCEPTION DISCOVERED ]', D_PK_WORKING
        #
        #
        import threading
        import time
        ...
        for traceback_format_exc_str in traceback_format_exc_list:
            ensure_printed(str_working=f'{'[ EXCEPTION DISCOVERED ]'} {traceback_format_exc_str}', print_color='red')
        ensure_printed(str_working=f'{PK_UNDERLINE}', print_color='red')
