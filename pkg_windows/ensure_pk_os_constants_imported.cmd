...
set D_DOWNLOAD=%USERPROFILE%\Downloads
set D_PK_SYSTEM=%D_DOWNLOAD%\pk_system
set D_PK_WORKING=%D_DOWNLOAD%\pk_working
set D_PK_MEMO=%D_DOWNLOAD%\pk_memo
...
setx D_DOWNLOAD "%D_DOWNLOAD%"
setx D_PK_SYSTEM "%D_DOWNLOAD%\pk_system"
setx D_PK_WORKING "%D_DOWNLOAD%\pk_working"
setx D_PK_MEMO "%D_DOWNLOAD%\pk_memo"
setx D_PKG_WINDOWS "%D_PK_SYSTEM%\pkg_windows"
setx D_PKG_EXE "%D_PK_SYSTEM%\pkg_exe"
