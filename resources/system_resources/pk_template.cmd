...
set python_file=task_orchestrator_cli_backup_pnxs_as_deprecated.py
...
python task_orchestrator_cli.py


:: kill 
wmic process where name="task_orchestrator_cli.exe" delete
taskkill /f /im task_orchestrator_cli.exe
