def get_time_as_(pattern: str):
    ...
    time_styles = {
        ...
        'yyyy MM dd weekday HHmm': f"{now.year} {now.month:02} {now.day:02} {weekday} {now.hour:02} {now.minute:02}",
        'yyyy MM dd weekday': f"{now.year} {now.month:02} {now.day:02} {weekday}",
    }
