def get_str_from_file(pnx):
    ...
    # 디버깅 정보
    logging.debug(f"DEBUG: get_str_from_file - pnx={pnx}")
    logging.debug(f"DEBUG: raw_lines={lines}")
    ...
    logging.debug(f"DEBUG: cleaned_lines={lines}")
    ...
    logging.debug(f"DEBUG: final_prompt='{prompt}'")
    return prompt
