...
# from pkg_py.pk_system_object.500_live_logic import get_pnx_list_from_d_working, get_str_from_list, get_nx, get_list_calculated, get_list_contained_element
# from pkg_py.pk_system_object.static_logic import D_TESTS
...
if __name__ == "__main__":
    # TBD : 테스트 TODO.
    test_files = get_pnx_list_from_d_working(d_working=D_TESTS)
    test_suffix = 2025
