...
from pkg_py.refactor.pk_ensure_functions_splited import restore_workspace_from_latest_archive, backup_workspace
...
def pk_ensure_filecontents_renamed_from_old_str_to_new_str():
    while True:
        ...
        if LTA:
            old_str = r"pkg_py\.split_functions\.part_\d+_"  # part_{숫자}_ 패턴을 pkg_py.functions_split.으로 변경
        else:
            key_name = "old_str"
